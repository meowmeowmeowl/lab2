...
{
    subforwardlist* node = new subforwardlist{ d, nullptr };
    if (*sfl == nullptr) {
        *sfl = node;
        return 0;
    }
    subforwardlist* copy = *sfl;
